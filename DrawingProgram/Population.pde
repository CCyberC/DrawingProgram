...
//
void Population() {
  canvasX = displayWidth*(1.0/2.0); //displayWidth
  canvasY = displayHeight*(1.0/4.0); //displayHeight
  canvasWidth = displayWidth*(12.0/24.0); //displayWidth
  canvasHeight = displayHeight*(1.0/2.0); //displayHeight
  circleDiameter = displayWidth*(1.0/100.0);
  //
  ItLX = canvasX+(displayWidth*(1.0/140.0));
  ItLY = canvasY+(displayHeight*(1.0/120.0));
  ItLW = canvasWidth-(displayWidth*(1.0/70.0));
  ItLH = canvasHeight-(displayHeight*(1.0/60.0));
  //
  ExitX = displayWidth*(9.0/10.0);
  ExitY = displayHeight*(0.0/0.0);
  ExitWidth = displayWidth*(1.0/10.0);
  ExitHeight = displayHeight*(1.0/20.0);
  //
  Text2X = ExitX;
  Text2Y = displayHeight*(1.0/20.0);
  ...
  rMX3 = (appWidth*(4.0/24.0))+(appWidth*r2Width);
  ...
  rMX14 = rMX1;
  rMX15 = rMX2;
  rMX16 = (appWidth*(4.0/24.0))+(appWidth*r3Width);
  ...
  rMX48 = rMX2;
  rMX49 = (appWidth*(4.0/24.0))+(appWidth*r4Width);
  ...
  rMY18 = rMY15;
  //
  rMY19 = (appHeight*rMY1)+(appHeight*(2.0/6.0));
  rMY20 = appHeight*(2.0/6.0);
  rMY21 = rMY20;
  rMY22 = rMY20;
  rMY23 = rMY20; 
  //
  rMY24 = (appHeight*rMY20)+(appHeight*(1.0/2.0)*(1.0/6.0));
  rMY25 = rMY24;
  rMY26 = rMY24;
  rMY27 = rMY24;
  //
  rMY28 = (appHeight*rMY1)+(appHeight*3.0/6.0);
  rMY29 = appHeight*(3.0/6.0);
  rMY30 = rMY29;
  rMY31 = rMY29;
  rMY32 = rMY29;
  //
  rMY33 = (appHeight*rMY1)+(appHeight*(4.0/6.0));
  rMY34 = appHeight*(4.0/6.0);
  rMY35 = rMY34;
  rMY36 = rMY34;
  rMY37 = rMY34;
  //
  rMY38 = (appHeight*rMY1)+(appHeight*5.0/6.0);
  ...
  rMY47 = rMY39; 
  //
  rMY48 = (appHeight*rMY39)+(appHeight*(1.0/2.0)*(1.0/6.0));
  rMY49 = rMY48;
  rMY50 = rMY48;
  rMY51 = rMY48;
  rMY52 = rMY48;
